...
<div class="container-fluid">
  ...
  <div id="user-alerts">
   ...
   <div class="row">
        <div class="col-md-12">
            <div class="card">
              <div class="card-header">Satım Dışı Gelir Ekleme</div>
              <div class="card-body">
                <form method="post" action="<?php echo APP_URL.'gelir';?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-12 col-10 ">
                      <select class="js-example-basic-single col-12" id="select_category" style="width:100%;" name="gelirKategori_id">
                  ...
                  <hr>
                  <div class="form-group row">
                    <label for="birim_alis_fiyat" class="col-4 col-form-label">Birim Satış Fiyatı</label> 
                    <div class="col-8">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <div class="input-group-text">
                        ...
                        <input id="birim_alis_fiyat" name="birim_satis_fiyat" type="number" step="0.01" min="0" class="form-control" required="required" aria-describedby="birim_alis_fiyat"> 
...
<script type="text/javascript">
  ...
  $('body').on("change",":input[name=birim_satis_fiyat],:input[name=miktar]",function(){
    toplam_fiyat();
  });

  function toplam_fiyat(){
    var baf = $(':input[name=birim_satis_fiyat]').val();
