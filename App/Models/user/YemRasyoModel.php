...
class YemRasyoModel extends BaseModel
{	
	protected $timestamp ;
	protected $Auth ;

	public $table='satisdisigelir';
	...
	public  function save($posts){
		$sql = 'INSERT INTO '.$this->table.' (gelirKategori_id,adi,miktar,birim,birim_satis_fiyat,toplam_fiyat,tarih,user_id) VALUES (:gelirKategori_id,:adi,:miktar,:birim,:birim_satis_fiyat,:toplam_fiyat,:tarih,:user_id)'; 
